...
var _ticketConfig = require("./modules/tab/ticketConfig");
var _faqConfig = require("./modules/tab/faq-config");
var _trainerSlider = require("./modules/trainer/trainer-slider");
var _faqAccordion = require("./modules/faq/faq-accordion");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  var ticket = new _tab.Tab(new _ticketConfig.TicketConfig());
  ticket.init();
  var faqTab = new _tab.Tab(new _faqConfig.FaqConfig());
  faqTab.init();
  var trainer = new _trainerSlider.Trainer();
  trainer.event();
  var accordion = new _faqAccordion.Accordion();
  accordion.init();
...
},{"./modules/faq/faq-accordion":2,"./modules/form-validate/form":4,"./modules/modals/init-modals":10,"./modules/tab/faq-config":12,"./modules/tab/tab":13,"./modules/tab/ticketConfig":14,"./modules/trainer/trainer-slider":15,"./modules/video/video":16,"./utils/ios-vh-fix":19}],2:[function(require,module,exports){
"use strict";
...
var Accordion = /*#__PURE__*/function () {
  function Accordion() {
    ...
    this.textClassActive = "".concat(this.textClass, "--active");
  }
  _createClass(Accordion, [{
    ...
    value: function init() {
      ...
      this.content.forEach(function (elem) {
        var checkbox = elem.querySelector(".".concat(_this.checkboxClass));
        var text = elem.querySelector(".".concat(_this.textClass));
        _this.event(elem, checkbox, text);
      });
    }
  }, {
    key: "event",
    value: function event(elem, checkbox, text) {
      var _this2 = this;
      elem.addEventListener('change', function () {
        if (checkbox.checked) {
          text.classList.add("".concat(_this2.textClassActive));
        } else {
          text.classList.remove("".concat(_this2.textClassActive));
        }
      });
    }
  }]);
...
exports.FaqConfig = void 0;
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var FaqConfig = /*#__PURE__*/_createClass(function FaqConfig() {
  _classCallCheck(this, FaqConfig);
  ...
  _createClass(Tab, [{
    ...
    value: function event(element) {
      ...
      element.addEventListener('click', function () {
        var tabId = element.dataset.id;
        var currentTab = document.querySelector(".".concat(_this2.tab, "[data-tab=\"").concat(tabId, "\"]"));
        _this2.hide();
        _this2.show(element, currentTab);
      });
    }
  }, {
    key: "show",
    value: function show(btn, tab) {
    ...
    value: function hide() {
      ...
      this.tabs.forEach(function (tab) {
        tab.classList.remove(_this3.tabActive);
      });
      this.btns.forEach(function (btn) {
        btn.classList.remove(_this3.btnActive);
      });
    }
  }]);
  return Tab;
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var TicketConfig = /*#__PURE__*/_createClass(function TicketConfig() {
  _classCallCheck(this, TicketConfig);
...
var Trainer = /*#__PURE__*/function () {
  function Trainer() {
    ...
    this.classActive = "".concat(this.classItem, "--active");
  ...
  _createClass(Trainer, [{
    ...
    value: function event() {
      ...
      this.container.addEventListener('click', function (evt) {
        var target = evt.target.closest(".".concat(_this.classItem));
        target.classList.toggle(_this.classActive);
      });
    }
  }]);
  return Trainer;
...
var Video = /*#__PURE__*/function () {
  ...
  _createClass(Video, [{
    ...
    key: "hide",
    value: function hide() {
      this.videoWrap.classList.toggle("".concat(this.videoWrapHide));
