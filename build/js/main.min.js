...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/tab/tab":11,"./modules/tab/ticketConfig":12,"./modules/trainer/trainer-slider":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
  ...
  _createClass(Tab, [{
    ...
    value: function event(element) {
      ...
      element.addEventListener('click', function () {
        ...
        var currentTab = document.querySelector("[data-tab=\"".concat(tabId, "\"]"));
        _this2.hide();
